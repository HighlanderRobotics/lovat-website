...
<section class="hero">
	...
	>
		<ellipse
			...
			rx="705.181"
			ry="344"
			transform="rotate(-23.8966 660.082 425.172)"
			fill="url(#paint0_radial_233_10)"
		/>
		<defs>
			<radialGradient
				id="paint0_radial_233_10"
				cx="0"
				cy="0"
				r="1"
				gradientUnits="userSpaceOnUse"
				gradientTransform="translate(660.082 425.172) rotate(90) scale(344 705.181)"
			>
	...
	<div class="content-wrapper">
		<div class="content">
			...
			<div class="button-items">
				<Button variant="primary" element="a" href="/get-updates">Keep me updated</Button
				>
				<!-- <a href="/dashboard/download">
					<span>Get Lovat Dashboard</span>
