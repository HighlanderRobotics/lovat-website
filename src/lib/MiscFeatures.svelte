...
<section>
    <div class="content">
        <div class="feature">
            ...
            <p>The Lovat apps support iOS and Android, with more on the way. Scouters can use their existing devices, and Lovat&nbsp;Dashboard users can use the same account on any device.</p>
        </div>
        <div class="feature">
            <Icon icon="cloud_off" />
        ...
        <div class="feature">
            <Icon icon="schedule" />
            <h2>Quick setup</h2>
            <p>Register your team for Lovat&nbsp;Dashboard in minutes, without a member of our team. Or join your existing team on Lovat&nbsp;Dashboard or Lovat&nbsp;Collection in one step.</p>
        </div>
    </div>
</section>
