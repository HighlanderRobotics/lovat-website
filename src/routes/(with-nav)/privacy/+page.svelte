...
<div class="content">
	...
	<ul>
		...
		<li>
			<p>
				<strong>Service</strong> refers to the Lovat system, including Lovat&nbsp;Collection and Lovat&nbsp;Dashboard,
				the software programs provided by the Team.
			</p>
		</li>
		<li>
			<p>
				<strong>Team</strong> (referred to as either &quot;the Team&quot;, &quot;We&quot;, &quot;Us&quot;
				or &quot;Our&quot; in this Agreement) refers to Highlander Robotics.
			</p>
		</li>
		<li>
		...
		<li>
			<p>
				...
				behalf of the Team. It refers to third-party companies or individuals employed by the Team to
				facilitate the Service, to provide the Service on behalf of the Team, to perform services related
				to the Service or to assist the Team in analyzing how the Service is used.
			</p>
		</li>
		<li>
			<p>
		...
		<li>
			<p>
				<strong>You</strong> means the individual accessing or using the Service, or the team, or other
	...
	<p>
		When You access the Service by or through means including but not limited to a mobile device,
		websites associated with the Service, and APIs, We may collect certain information
	...
	<p>The Team may use Personal Data for the following purposes:</p>
	<ul>
		<li>
			<p>
	...
	<p>
		The Team will retain Your Personal Data only for as long as is necessary for the purposes set
		out in this Privacy Policy. We will retain and use Your Personal Data to the extent necessary to
		comply with our legal obligations (for example, if we are required to retain your data to comply
		with applicable laws), resolve disputes, and enforce our legal agreements and policies.
	</p>
	<p>
		The Team will also retain Usage Data for internal analysis purposes. Usage Data is generally
	...
	<p>
		Your information, including Personal Data, is processed at the Team's operating offices and in
	...
	<p>
		The Team will take all steps reasonably necessary to ensure that Your data is treated securely
	...
	<p>
		You may update, amend, or delete Your information at any time using the settings page of
		Lovat&nbsp;Dashboard. You may also contact Us to request access to, correct, or delete any
	...
	<p>
		Under certain circumstances, the Team may be required to disclose Your Personal Data if required
		to do so by law or in response to valid requests by public authorities (e.g. a court or a
		government agency).
	</p>
	<h3>Other legal requirements</h3>
	<p>
		The Team may disclose Your Personal Data in the good faith belief that such action is necessary
		to:
	</p>
	<ul>
		<li>Comply with a legal obligation</li>
		<li>Protect and defend the rights or property of the Team</li>
	...
	<ul>
		<li>By email: frc8033@piedmontmakers.org</li>
	</ul>
</div>
