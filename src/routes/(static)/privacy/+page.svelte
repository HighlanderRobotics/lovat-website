...
<div class="content">
    ...
    <ul>
        ...
        <li>
            <p>
                ...
                of the Team. It refers to third-party companies or individuals employed by the Team to facilitate
                the Service, to provide the Service on behalf of the Team, to perform services related to the
                Service or to assist the Team in analyzing how the Service is used.
            </p>
        </li>
        <li>
            <p>
    ...
    <p>
        When You access the Service by or through means including but not limited to a mobile device, websites associated with the Service, and APIs, We may collect certain information
    ...
    <p>
        Under certain circumstances, the Team may be required to disclose Your Personal Data if
